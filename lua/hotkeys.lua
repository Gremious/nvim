...
keymap.set('n', '<F11>', ':let g:neovide_fullscreen = (g:neovide_fullscreen == v:true) ? v:false : v:true<cr>', { silent = true })
...
keymap.set('n', '<C-Up>',   function() ChangeScaleFactor(1.25) end)
keymap.set('n', '<C-Down>', function() ChangeScaleFactor(1/1.25) end)
